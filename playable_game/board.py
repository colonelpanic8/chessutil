...
class ChessBoard(object):
    ...
    def set_piece(self, position, piece=piece.Empty()):
        if piece == :
    ...
    def is_color_or_empty_square(self, rank_index, file_index, color=common.color.WHITE):
        return self.is_color_piece_on_square(rank_index, file_index, color=color) or self.is_empty_square(rank_index, file_index)

    def is_color_piece_on_square(self, rank_index, file_index, color=common.color.WHITE):
    ...
    def is_empty_square(self, rank_index, file_index):
        return self.is_legal_square(rank_index, file_index) and \
            self.get_piece_color_on_square(rank_index, file_index) == common.color.NONE
